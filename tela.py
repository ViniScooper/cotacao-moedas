...
# Adiciona a imagem
imagem = tk.PhotoImage(file="imgtela.jpg")
label_imagem = tk.Label(janela, image=imagem, bg="orange")
...
mostrar_button = tk.Button(janela, text="Mostrar Cotação", command=atualizar_cotacoes, font=('Arial', 12, 'bold'), bg="#EEE8AA", fg="black")
